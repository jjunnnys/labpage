...
//               message = "값이 너무 짧습니다. 최솟값 : '" + $this.attr("minlength") + "' characters<!-- data-validation-minlength-message to override -->";
...
//               message = "올바른 이메일 형식이 아닙니다.<!-- data-validator-validemail-message to override -->";
